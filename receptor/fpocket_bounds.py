...
parser = argparse.ArgumentParser(description="Usage: fpocket_bounds.py fpocket_folder pocket [--pymol] [--autodock] [--bounds] [-B box_padding] [-rep times_repeated] [--conf] [-o output]")
parser.add_argument("fpocket_folder", help="Diretory of output from fpocket")
parser.add_argument("pocket", help="A string of one or more pockets, seperated by commas or dashes with no spaces")
...
parser.add_argument("-r", "--rep", type=int, 
	...
	default=2)
parser.add_argument("-o", "--output",type=float, 
