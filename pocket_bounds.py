...
parser = argparse.ArgumentParser(description="Takes a pdb file and a list of amino acids and outputs a list of amino acids in the format required for vina, and can make an appropriate conf file.")
parser.add_argument("pdb_file", 
	help="Protein pdb file")
parser.add_argument("aa_list", 
	help="A string of amino acid numbers, seperated by + or , only")
