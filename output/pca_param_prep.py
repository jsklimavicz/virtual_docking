...
parser.add_argument("-o", metavar="output_filename", dest = "output",
	help="Name (without extension) of the output csv file without extension. Default is ""pca_output""[.csv].",
	default = "pca_output")
...
new_header = header.strip() + "," + new_header_labels + "\n"
...
file_out = open(args.output+".csv", "w")
